  ...
  return (
    <div ref={ref} className="aboutpage">
      ...
      <div className="subhead">
        <label>
          RVesting is your one-stop platform for all things crypto trading and
          investment. Whether you're an experienced trader or a beginner looking
          to explore the crypto market, we've got you covered.
        </label>
      </div>
      <div className="weoffer">
        ...
        <div className="subhead">
          <ul>
            <li>
              <b>Seamless Crypto Trading:</b> Effortlessly buy and sell
              cryptocurrencies with our user-friendly interface.
            </li>
            <li>
